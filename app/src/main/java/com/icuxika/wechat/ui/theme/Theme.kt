package com.icuxika.wechat.ui.theme
...
private val LightColorPalette = KtComposeWeChatColors(
    bottomBar = white1,
    background = white2,
    listItem = white,
    divider = white3,
...
private val DarkColorPalette = KtComposeWeChatColors(
    bottomBar = black1,
    background = black2,
    listItem = black3,
    divider = black4,
...
private val NewYearColorPalette = KtComposeWeChatColors(
    bottomBar = red4,
    background = red5,
    listItem = red2,
    divider = red3,
...
private val LocalKtComposeWeChatColors = compositionLocalOf {
    LightColorPalette
}

object KtComposeWeChatTheme {
    val colors: KtComposeWeChatColors
        @Composable
        get() = LocalKtComposeWeChatColors.current
...
@Composable
fun KtComposeWeChatTheme(
    theme: KtComposeWeChatTheme.Theme = KtComposeWeChatTheme.Theme.Light,
    content: @Composable () -> Unit
) {
    val targetColors = when (theme) {
        KtComposeWeChatTheme.Theme.Light -> LightColorPalette
        KtComposeWeChatTheme.Theme.Dark -> DarkColorPalette
        KtComposeWeChatTheme.Theme.NewYear -> NewYearColorPalette
    }
    ...
    CompositionLocalProvider(LocalKtComposeWeChatColors provides colors) {
        MaterialTheme(
            shapes = shapes,
            content = content
        )
